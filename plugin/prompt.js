 ...
 * dentro de una interfaz de procesamiento de lenguaje natural especializadaVOZEMPRENDE y gestión empresarial.
 * Este objeto es utilizado para estructurar las respuestas dadas a las preguntas de los usuarios,
 * asegurando que la interacción siga un formato coherente que resalta los servicios y beneficios ofrecidos por VOZEMPRENDE.
 */
const PROMPTS = {
    /**
     * Prefijo utilizado para iniciar la interacción con el usuario. Presenta los servicios de VOZEMPRENDE,
     ...
     * los servicios de VOZEMPRENDE, la acción a tomar utilizando las herramientas disponibles, la entrada para dicha acción,
    ...
    FORMAT_INSTRUCTIONS: `Use the following format in your response:
        ...
        Thought: I now know the final answer, considering the comprehensive business support VOZEMPRENDE provides
     ...
     * Empresarial que VOZEMPRENDE ofrece.
     */
    ...
    * instruye al agente para actuar como un empleado de VOZEMPRENDE, proporcionando
    ...
    */
     ...
     * VOZEMPRENDE. Este componente es crucial para asegurar que cada comunicación
